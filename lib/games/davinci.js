...
module.exports = { id: 'davinci', name: '다빈치 코드', size: 4, rules: '흑·백 타일의 숨겨진 숫자를 추리해 마지막까지 살아남으세요.', create, reset, start, select, guess, stop, reveal, tick, publicState, tilesFor, drawnFor, moveError };
