...
function moveError(reason) {
  return ({ 'already-started': '이미 시작했습니다.', 'player-count': '2~4명이 자리를 선택해야 합니다.',
...
module.exports = { id: 'oldmaid', name: '도둑잡기', size: 0,
  rules: '2~4명이 53장(조커 1장 포함)을 나누고 같은 계급의 카드 두 장씩 자동으로 버립니다. 내 차례에는 다음 활성 참가자의 뒷면 카드 한 장을 골라 뽑습니다. 카드 섞기로 내 손패 순서를 바꿀 수 있습니다. 짝을 버려 손패를 모두 없애면 승리하며 마지막 조커 보유자가 패배합니다. 특수 능력 모드에서는 시작할 때 각자 엿보기·방향전환·방어막·조커탐지 중 하나를 무작위로 받아 게임당 1회 사용할 수 있습니다.',
