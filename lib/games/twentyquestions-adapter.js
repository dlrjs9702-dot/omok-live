...
const metadata = {
  ...
  name: '스무고개',
  size: 0,
  rules: '2~8명 개인전 또는 협동전. 방장이 1~10라운드를 정하고 출제자는 자리 순서대로 교대합니다. 매 라운드 무작위 카테고리 안에서 출제자가 비밀 정답을 정합니다. 도전자들은 순서대로 질문하거나 정답을 제출합니다. 질문은 총 20개이며 출제자는 예·아니오·비슷함·애매함으로 답하고 정답을 직접 판정합니다. 오답은 다음 사람 차례입니다. 20개 질문을 쓰면 도전자 전원에게 1회씩 마지막 정답 기회가 주어집니다. 개인전은 정답자에게 1점, 실패 시 출제자에게 1점. 협동전은 한 명만 맞혀도 도전자 전원에게 1점, 실패 시 출제자에게 1점. 전체 라운드 누적 최고점자가 승리하고 동점은 공동 승리합니다.',
};
...
module.exports = { ...core, ...metadata, create, reset, beginRound, nextRound, judgeGuess, publicState, moveError };
